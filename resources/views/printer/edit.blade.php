    ...
    <form action="{{route('printer.update', $printer->id)}}" method="POST">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="text" class="form-control" name="manufacturer" value="{{ $printer->manufacturer }}">
            </div>

            <div class="form-group col-md-4">

                <label for="model" col-sm-2 col-form-label>Modelo*</label>
                <input type="text" class="form-control" name="model" value="{{ $printer->model }}">
            </div>
        ...
        <div class="form-row">
                ...
                <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" name="tonner" value="{{ $printer->tonner }}">
                </div>
        ...
        <div class="form-group col-md-4">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" name="serial_number" value="{{ $printer->serial_number }}">
                </div>

                <div class="form-group col-md-3">
                    <label for="bmp_number" col-sm-2 col-form-label>Número BMP</label>
                    <input type="text" class="form-control" name="bmp_number" value="{{ $printer->bmp_number }}">
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" name="year_acquisition" value="{{ $printer->year_acquisitn }}">
                </div>
